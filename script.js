...
Person.prototype.myFriend5 = function(friends) {
    ...
    var arr = friends.map(function(el) {
        return this.name + ' is a friends with ' + el;
    }.bind(this));
    console.log(arr);
}
...
Person.prototype.myFriend6 = function(friends) {
    ...
    var arr = friends.map(el => `${this.name} is a friends with ${el}`);
    console.log(arr);
}
...
//isFullAge5(1990, 1999, 1965, 2016, 1980, 2018);

//ES6
function isFullAge6(...years) {
    years.forEach(cur => console.log((2019 - cur) >= 18));
}
isFullAge6(1990, 2004, 1965, 2016, 1987);
*/
/*
////
//ES5
...
isFullAge6(16, 1990, 2004, 1965, 2016, 1987);
*/
...
question.set('question', 'What is official name of the lateste major JavaScript version?');
question.set(1, 'ES5');
question.set(2, 'ES6');
...
//question.forEach((value, key) => console.log(`This is a ${key} and it's set to a ${value}`));
...
Person5.prototype.calculateAge = function(yearOfBirth) {
...
const john6 = new Person6('John', 1990, 'sales person');
Person6.greeting();
*/
...
var Athlete5 = function(name, yearOfBirth, job, olimpycGames, medals) {
    Person5.call(this, name, yearOfBirth, job);
    this.olimpycGames = olimpycGames;
    this.medals = medals;
}
...
class Athlete6 extends Person6 {
    constructor (name, yearOfBirth, job, olimpycGames, medals) {
...
class Street  extends Element {
    ...
    classifyStreet() {
        const classification = new Map(); //tiny/small/normal/big/huge
...
const allStreets = [new Street('Ocean Avenue', 1998, 1.1, 4),
...
function reportStreets(s) {
    ...
    console.log(`our ${s.length} streets have a total length of ${totalLength} km, with an average ${avgLength} km.`);
...
class Park extends Element{
    ...
    treeDensity(){
        const density = this.numTrees / this.area; // per sq km
        console.log(`${this.name} has a tree density of ${density} per sq km.`) 
    }
}
...
class Street extends Element{
    ...
    classifyStreet() {
        ...
        classification.set = [4, 'big'];
        classification.set = [5, 'huge'];
        console.log(`${this.name}, build in ${this.buildYear} and it's a ${classification.get(this.size)} street.`)
    }
}

const allParks = [
    new Park('CentralPark', 2004, 787, 0.4),
    new Park('National Park', 1922, 2041, 2.5),
    new Park('Evergreen', 2002, 981, 0.9)
]

const allStreets = [
    new Street('Promenade street', 1911, 0.9, 2),
    new Street('Sunset Avenue', 1952, 3.1, 4),
    new Street('Yong street', 2001, 2.4),
    new Street('4th street', 1982, 0.9, 1)
]
